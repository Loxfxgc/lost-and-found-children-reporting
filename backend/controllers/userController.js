  ...
  try {
    ...
    if (user.profilePicture) {
      try {
        ...
        console.error('Error deleting previous profile picture from Cloudinary:', error);
        // Continue even if deletion fails
      }
    }
    
    // Update with new profile picture (store Cloudinary public_id)
    user.profilePicture = req.file.filename;
    user.profilePictureUrl = req.file.path; // Store the Cloudinary URL
    await user.save();
